...
from .difficulty import DIFFICULTY_GRADES, grade_for_difficulty
...
# Kilter's currentDifficultyId indexes the shared Aurora difficulty table (see difficulty.py).
KILTER_DIFFICULTY_GRADES = DIFFICULTY_GRADES
...
def kilter_grade(difficulty_id: Optional[int]) -> Optional[dict]:
    ...
    return grade_for_difficulty(difficulty_id)
